...
<div class="container">
    ...
    <div class="alerta-erro">
        <p style="margin: 0; font-size: 14px;">⚠️ <?php echo htmlspecialchars($erro); ?></p>
    </div>
<?php endif; ?>
...
<div class="form-container">
    <form action="cadastrar.php" method="post">
        ...
        <label for="nome">Nome do Projeto: <span style="color: #cfc121;">*</span></label>
        <input type="text"
            id="nome"
            name="nome"
        ...
        <label for="descricao">Descrição: <span style="color: #cfc121;">*</span></label>
        <textarea id="descricao"
            name="descricao"
            rows="4"
            placeholder="Descreva o projeto em 2–3 frases..."><?php echo htmlspecialchars($form
            ['descricao']); ?></textarea>
...
<p style="margin-top: 20px; text-align: center;">
    <a href="index.php" style="color:cornflowerblue;"> voltar à listagem</a>
</p>
</div>
