...
$titulo_pagina = 'Cadastrar Projeto — Portifólio';
$caminho_raiz = '../';
$pagina_atual = '';
?>
...
<div class="container">
    ...
    <div class="form-container">
        <form action="cadastrar.php" method="post">
            ...
            <label for="nome">
                Nome do Projeto: <span style="color: red;">*</span>
            </label>
            <input type="text"
                id="nome"
                name="nome"
            ...
            <textarea id="descricao"
                name="descricao"
                rows="4"
                placeholder="Descreva o projeto em 2-3 frases..."><?php echo htmlspecialchars($form['descricao']); ?>
            </textarea>

            <label for="tecnologias">
                Tecnologias Usadas: <span style="color: red;">*</span>
            </label>
            <input type="text"
                id="tecnologias"
                name="tecnologias"
            ...
            <label for="link_github">
                Link do Github: <span style="color: #6b7280; font-weight: normal";>(opcional)</span>
            </label>
            <input type="url"
                id="link_github"
                name="link_github"
            ...
            <button type="submit">🖨️ Salvar Projeto</button>
